...
const IndexPage = () => {
  return (
    <Layout>
      ...
      <ProductsFeatured title="Hàng mới về" apiUrl="/api/products" url="/products" />
      <ProductsFeatured title="Hàng khuyến mãi" apiUrl="/api/products" url="/products" />
      <ProductsFeatured title="Hàng bán chạy" apiUrl="/api/products" url="/products" />
